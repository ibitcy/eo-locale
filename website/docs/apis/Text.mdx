...
If `count='1'`, component will display like: <Highlight><PreviewPlural count='1' /></Highlight>

If `count='4'`, component will display like: <Highlight><PreviewPlural count='4' /></Highlight>
